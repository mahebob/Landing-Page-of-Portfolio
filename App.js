    ...
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <section 
        ...
        className={`min-h-screen flex items-center grid-cols-1 md:grid-cols-2 gap-2 px-8 md:px-16 transform transition-all duration-1000 ${
          isVisible.home ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'
        }`}
      >
        <div className="max-w-4xl  ">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            Hello, I'm <span className="text-blue-500">Maheboob</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-400 mb-8">
            Full Stack Developer specializing in modern web applications
          </p>
          <div className='md:hidden '>
          <img src={kola}  className=' rounded-xl w-24 mb-8 '></img>
        </div>
     ...
     <a  href="https://wa.me/917709852396"> <FaSquareWhatsapp className="w-8 h-8 hover:text-blue-500 cursor-pointer transition-colors" /></a>
         ...
         <div className=' md:m-32'>
          <img src={kola}  className='rounded-xl  md:w-52 '></img>
        </div>
      ...
      <section 
        ...
        className={`min-h-screen px-8 md:px-16 py-24  transform transition-all duration-1000 ${
          isVisible.projects ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'
        }`}
      >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap  mb-4 ">
                  {project.tech.map(tech => (
                    <span key={tech} className="bg-blue-500/20  text-blue-500 px-3 py-1 rounded-full text-sm">
                      {tech}
                    </span>
                  ))}
                </div>
               <button className="bg-blue-500 px-6 py-3   rounded-full flex items-center space-x-2 hover:bg-blue-600 transition-colors">
